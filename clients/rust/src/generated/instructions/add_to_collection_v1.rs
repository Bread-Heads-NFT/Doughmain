...
impl AddToCollectionV1 {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let data = AddToCollectionV1InstructionData::new()
            .try_to_vec()
            .unwrap();
...
struct AddToCollectionV1InstructionData {
    discriminator: u8,
}

impl AddToCollectionV1InstructionData {
    fn new() -> Self {
        Self { discriminator: 0 }
    }
}

/// Instruction builder for `AddToCollectionV1`.
///
/// ### Accounts:
///
...
#[derive(Default)]
pub struct AddToCollectionV1Builder {
...
impl AddToCollectionV1Builder {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = AddToCollectionV1 {
...
/// `add_to_collection_v1` CPI accounts.
pub struct AddToCollectionV1CpiAccounts<'a, 'b> {
    /// The address of the collection
...
/// `add_to_collection_v1` CPI instruction.
pub struct AddToCollectionV1Cpi<'a, 'b> {
...
impl<'a, 'b> AddToCollectionV1Cpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: AddToCollectionV1CpiAccounts<'a, 'b>,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `AddToCollectionV1` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` collection
...
///   3. `[]` mpl_core_program
///   4. `[]` system_program
pub struct AddToCollectionV1CpiBuilder<'a, 'b> {
    instruction: Box<AddToCollectionV1CpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> AddToCollectionV1CpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(AddToCollectionV1CpiBuilderInstruction {
            __program: program,
            collection: None,
            payer: None,
            authority: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = AddToCollectionV1Cpi {
...
struct AddToCollectionV1CpiBuilderInstruction<'a, 'b> {
