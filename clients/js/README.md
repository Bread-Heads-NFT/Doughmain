# JavaScript client for Bgl Dough
...
2. Next, install this library using the package manager of your choice.
   ```sh
   npm install @metaplex-foundation/bgl-dough
   ```
2. Finally, register the library with your Umi instance like so.
   ```ts
   import { bglDough } from '@metaplex-foundation/bgl-dough';
   umi.use(bglDough());
   ```

You can learn more about this library's API by reading its generated [TypeDoc documentation](https://bgl-dough-js-docs.vercel.app).
