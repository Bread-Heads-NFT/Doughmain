...
use crate::error::BglDoughError;
use crate::instruction::accounts::CreateAccounts;
use crate::instruction::{CreateArgs, BglDoughInstruction};
...
pub fn process_instruction<'a>(
    ...
    let instruction: BglDoughInstruction =
        BglDoughInstruction::try_from_slice(instruction_data)?;
    match instruction {
        BglDoughInstruction::Create(args) => {
